...
!!! informação "Instalando no Amazon Linux 2.0.2021x e inferior"
...
* `wallarm-node` para o módulo [postanalytics][install-postanalytics-instr], banco de dados Tarantool e pacotes adicionais NGINX Plus-Wallarm
