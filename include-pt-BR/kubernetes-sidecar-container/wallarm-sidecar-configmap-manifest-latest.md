...
data:
  default: |
      server {
          ...
          # desativado para desativar o processamento de solicitações
          # monitorando para processar, mas não bloquear solicitações
          # bloqueio seguro para bloquear apenas aquelas solicitações maliciosas originadas de IPs listados como cinzas
