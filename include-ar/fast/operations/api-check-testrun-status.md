...
| ------------- | ------------------------------------------ | ---- |
| التفويض: | مطلوب | مع الرمز |
| العنوان HTTP مع الرمز: | `X-WallarmAPI-Token` | يستخدم لنقل قيمة الرمز إلى خادم API |
| المُعامِلات: | `test_run_id` **(مطلوب)** | معرف اختبار التشغيل الذي تريد الحصول على حالته |
