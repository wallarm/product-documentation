...
data:
  default: |
    ...
    server {
        ...
        # wallarm_instance 1;
        # قم بإزالة التعليق عن السطر التالي لتفعيل
        # وظيفة حظر IP
        # wallarm_acl default;
        ...
        location / {
                ...
                # الذي يقبل الحاوية طلبات الواردة عليه،
