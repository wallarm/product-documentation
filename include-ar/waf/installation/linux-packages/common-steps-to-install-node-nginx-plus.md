## 1. تثبيت NGINX Plus والاعتماديات

استخدم هذه [التعليمات الرسمية من NGINX](https://www.nginx.com/resources/admin-guide/installing-nginx-plus/) لتثبيت NGINX Plus واعتمادياته.

!!! info "التثبيت على Amazon Linux 2.0.2021x والإصدارات الأقل"
    لتثبيت NGINX Plus على Amazon Linux 2.0.2021x والإصدارات الأقل، استخدم تعليمات CentOS 7.

## 2. إضافة مستودعات Wallarm

يتم تثبيت وتحديث عقدة Wallarm من خلال مستودعات Wallarm. لإضافة المستودعات، استخدم الأوامر لمنصتك:
...
=== "CentOS 7.x"
    ...
    ```
=== "Amazon Linux 2.0.2021x والإصدارات الأقل"
    ```bash
...
=== "Ubuntu"
    ...
    sudo apt -y install --no-install-recommends wallarm-node nginx-plus-module-wallarm
    ```
=== "CentOS أو Amazon Linux 2.0.2021x والإصدارات الأقل"
    ```bash
...
## 5. ربط عقدة التصفية بـ Wallarm Cloud
