...
* [Vulnerabilities](../../../about-wallarm/detecting-vulnerabilities.md#what-is-security-issue) detected, all by default or only for the selected risk level(s) - high, medium or low.
