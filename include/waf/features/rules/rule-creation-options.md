You can create and apply the rule both in the **Attacks** and **Rules WAF** sections of Wallarm Console.
...
* In the **Rules WAF** section, all rule components must be filled in manually.
