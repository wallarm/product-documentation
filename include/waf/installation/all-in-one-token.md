To install the node, you will need a Wallarm token of the [appropriate type][wallarm-token-types]. To prepare a token:
...
=== "Node token"
    ...
    1. Do one of the following: 
        ...
        * Use an existing node group - copy the token using the node's menu → **Copy token**.