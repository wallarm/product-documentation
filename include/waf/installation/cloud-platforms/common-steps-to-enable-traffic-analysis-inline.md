By default, the deployed Wallarm node does not analyze incoming traffic. To start traffic analysis, configure Wallarm to proxy traffic via the `/etc/nginx/sites-enabled/default` file on the Wallarm instance:
