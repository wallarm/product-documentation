...
* [Security Group](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/creating-security-group.html) outbound access to:
    ...
    * Wallarm API host for your Cloud: `https://us1.api.wallarm.com` or `https://api.wallarm.com`. If access can be configured only via the proxy server, then use the [instructions][wallarm-api-via-proxy]
