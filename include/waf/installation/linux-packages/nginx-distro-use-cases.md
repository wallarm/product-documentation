Among all supported [Wallarm deployment options][platform], DEB/RPM packages for distribution-provided NGINX are recommended for Wallarm deployment in these **use cases**:
