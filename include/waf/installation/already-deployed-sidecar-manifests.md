!!! info "If you deploy several Wallarm nodes"
    ...
    The version of the deployed Wallarm filtering node image is specified in the Deployment template → `spec.template.spec.containers` section → `image` of the Wallarm container.
