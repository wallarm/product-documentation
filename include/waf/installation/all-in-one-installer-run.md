1. Run the downloaded script:
    ...
    === "API token"
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-7.1.1.x86_64-glibc.sh
        ```

        If using the ARM64 version:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-7.1.1.aarch64-glibc.sh
        ```        
    ...
    === "Node token"
        ...
        ```bash
        sudo sh wallarm-7.1.1.x86_64-glibc.sh
        ```

        If using the ARM64 version:

        ```bash
        sudo sh wallarm-7.1.1.aarch64-glibc.sh
        ```
