1. Run downloaded script:
    ...
    === "API token"
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-6.12.0.x86_64-glibc.sh
        ```

        If using the ARM64 version:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-6.12.0.aarch64-glibc.sh
        ```        
    ...
    === "Node token"
        ...
        ```bash
        sudo sh wallarm-6.12.0.x86_64-glibc.sh
        ```

        If using the ARM64 version:

        ```bash
        sudo sh wallarm-6.12.0.aarch64-glibc.sh
        ```
