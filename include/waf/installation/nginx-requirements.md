...
* For the request processing and postanalytics on different servers: postanalytics installed on the separate server according to the [instructions][install-postanalytics-instr]
