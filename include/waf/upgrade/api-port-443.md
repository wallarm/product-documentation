Starting with version 4.0, the filtering node uploads data to the Cloud using the `us1.api.wallarm.com:443` (US Cloud) and `api.wallarm.com:443` (EU Cloud) and `me1.api.wallarm.com:443` (ME Cloud) API endpoints instead of `us1.api.wallarm.com:444` and `api.wallarm.com:444`.
