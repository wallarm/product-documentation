Review data about your API collected by Wallarm's [**API Discovery**][apid-overview] with the **API Discovery** dashboard.

The dashboard provides the full landscape of your API endpoints, including shadow and zombie APIs. It visualizes the **risk score assessment** results helping prioritize security efforts by identifying the most vulnerable or high-risk APIs.
...
* How much your API endpoints are at risk is marked with the [risk score][apid-risk-score]
