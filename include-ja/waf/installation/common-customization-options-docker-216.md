...
* [NGINXディレクティブ`proxy_read_timeout`でのサーバー応答待ち時間の制限](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_read_timeout)
...
* [**libdetection**を使用した攻撃のダブル検出][enable-libdetection-docs]