...
## Step 4: Migrate allowlists and denylists from previous Wallarm node version to 3.4

If updating Wallarm node 2.18 or lower, migrate allowlist and denylist configuration from previous Wallarm node version to 3.4 following the [instructions](migrate-ip-lists-to-node-3.md).
