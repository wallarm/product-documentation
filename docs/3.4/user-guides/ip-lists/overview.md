...
!!! warning "IP list support"
    Controlling access to your applications by whitelisted, denylisted and graylisted IP addresses is supported starting with the regular (client) and multi-tenant Wallarm node of version 3.2.
