...
To launch an instance with the filter node, proceed to this [link](https://aws.amazon.com/marketplace/pp/B073VRFXSD) and select the `2.12.x` version during launching.
...
!!! info "If Wallarm WAF instance is already launched"
    ...
    * If the version `2.16.x` is installed, then follow the [instruction for 2.16](../../../admin-en/installation-ami-en/).
    * If the version `2.14.x` is installed, then follow the [instruction for 2.14](../../../2.14/admin-en/installation-ami-en/) or update all Wallarm WAF instances to 2.16.
