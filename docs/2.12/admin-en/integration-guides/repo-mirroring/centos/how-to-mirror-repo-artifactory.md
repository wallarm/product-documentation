...
1.  Add the Wallarm repository by executing the following command:
    ...
    === "CentOS 6.x"
        ```bash
        sudo rpm --install https://repo.wallarm.com/centos/wallarm-node/6/x86_64/Packages/wallarm-node-repo-1-3.el6.noarch.rpm
        ```
    === "CentOS 7.x"
        ```bash
        sudo rpm --install https://repo.wallarm.com/centos/wallarm-node/7/x86_64/Packages/wallarm-node-repo-1-3.el7.noarch.rpm
        ```
