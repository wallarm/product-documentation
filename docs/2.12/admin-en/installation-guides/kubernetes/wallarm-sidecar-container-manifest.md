...
!!! info "If Wallarm WAF is already installed in your environment"
    ...
    * If the version `2.16` is specified, follow the [instruction for 2.16](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
    * If the version `2.14` is specified, follow the [instruction for 2.14](../../../../../2.14/admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/) or increase the version of the image to `2.16` in all deployments and follow the [instruction for 2.16](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
    * If the version `2.12` or lower is specified, please increase the version of the image to `2.16` in all deployments and follow the [instruction for 2.16](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
