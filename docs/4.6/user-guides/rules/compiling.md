...
The status of unloading a custom ruleset to the filtering node is logged to the file `/var/log/wallarm/syncnode.log` (`/opt/wallarm/var/log/wallarm/syncnode-out.log` for all-in-one installer).
