...
These instructions describe the steps to upgrade Wallarm Sidecar 4.x to the new version with Wallarm node 4.6.
...
2. Run the plugin:
    ...
    * `<PATH_TO_VALUES>`: the path to the `values.yaml` file defining the Sidecar 4.6 settings - you can use the one created for running the previous Sidecar version
