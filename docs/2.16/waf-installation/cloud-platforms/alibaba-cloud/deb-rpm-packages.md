...
* [Install the Wallarm node as the NGINX Stable module](#installing-the-filtering-node-as-the-nginx-stable-module)
* [Install the Wallarm node as the NGINX Plus module](#installing-the-filtering-node-as-the-nginx-plus-module)
* [Install the Wallarm node as the Kong module](#installing-the-filtering-node-as-the-kong-module)
