# What is new in Wallarm node 2.16
...
* Decreased default interval between the filtering node and Wallarm Cloud synchronizations. Now default interval is 120 seconds. [More details about the filtering node and Wallarm Cloud synchronization configuration →](../admin-en/configure-cloud-node-synchronization-en.md)
