...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------- |
| NGINX `stable` installed on the 64-bit operating system from the list:<ul><li>Debian 9.x (stretch)</li><li>Debian 10.x (buster)</li><li>Ubuntu 16.04 LTS (xenial)</li><li>Ubuntu 18.04 LTS (bionic)</li><li>CentOS 7.x</li><li>Amazon Linux 2</li><li>CentOS 8.x</li></ul> | <ul><li>[Module for NGINX `stable` from the NGINX repository](../waf-installation/nginx/dynamic-module.md)</li><li>[Module for NGINX `stable` from the Debian/CentOS repository](../waf-installation/nginx/dynamic-module-from-distr.md)</li><li>[Docker container](installation-docker-en.md)</li></ul>                                                                                                                                              |
...
| Cloud platforms                                                                                        | <ul><li>[Amazon AWS image][link-ig-aws]</li><li>[Google Cloud image][link-ig-gcloud]</li><li>[Yandex.Cloud image](installation-guides/install-in-yandex-cloud.md)</li></ul>                                                                                                                                              |
...
| Envoy                                                                                                  | <ul><li>[Docker container](installation-guides/envoy/envoy-docker.md)</li></ul>                                                                                            |
