...
API、MCP、AI エージェントを発見し、脅威から保護し、脆弱性をテストするために必要なすべての情報。
...
<div class="navigation navigation-1col">
  <div class="navigation-card homepage-intro">
    <h3 class="icon-homepage quick-start-title"><a href="./about-wallarm/overview/">はじめに <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Wallarm プラットフォームで基本を学びましょう。</p>
    <p><ul>
      <li><a href="./about-wallarm/overview/">プラットフォーム概要</a></li>
      <li><a href="./quickstart/getting-started/">クイックスタート</a></li>
...
<div class="navigation navigation-4col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage api-discovery-title"><a href="./api-discovery/overview/">API ディスカバリ <span class="card-arrow">→</span></a></h3>
    <p class="card-description">API/MCP/エージェント、リスク、機密データフローをすべてカタログ化。</p>
    <p><ul>
      <li><a href="./api-discovery/exploring/">API の探索</a></li>
      <li><a href="./api-discovery/risk-score/">リスクスコア</a></li>
      <li><a href="./api-discovery/rogue-api/">Rogue API（シャドウ/ゾンビ）</a></li>
      <li><a href="./api-discovery/sensitive-data/">機密データ検出</a></li>
      <li><a href="./api-discovery/setup/">セットアップと設定</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-threat-prevent"><a href="./about-wallarm/api-protection-overview/">API 保護 <span class="card-arrow">→</span></a></h3>
    <p class="card-description">インテリジェントな脅威検出で攻撃、ボット、悪用をリアルタイムにブロック。</p>
    <p><ul>
      <li><a href="./api-sessions/overview/">API セッション</a></li>
      <li><a href="./api-specification-enforcement/overview/">API 仕様の強制</a></li>
      <li><a href="./api-abuse-prevention/overview/">ボット管理</a></li>
      <li><a href="./about-wallarm/credential-stuffing/">Credential Stuffing</a></li>
      <li><a href="./about-wallarm/waap-overview/">脅威保護（WAAP）</a></li>
      <li><a href="./user-guides/rules/rules/">ルールとポリシー</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-security-testing"><a href="./vulnerability-detection/security-testing-overview/">API セキュリティテスト <span class="card-arrow">→</span></a></h3>
    <p class="card-description">自動セキュリティテストで攻撃者より先に脆弱性を発見。</p>
    <p><ul>
      ...
      <li><a href="./api-attack-surface/overview/">攻撃対象範囲（AASM）</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage agent-ai-title"><a href="./agentic-ai/agentic-ai-discovery/">AI セキュリティ <span class="card-arrow">→</span></a></h3>
    <p class="card-description">AI エージェントと MCP を発見し保護。</p>
    <p><ul>
      <li><a href="./agentic-ai/agentic-ai-discovery/">AI エージェントディスカバリ</a></li>
      <li><a href="./agentic-ai/agentic-ai-protection/">AI エージェント保護</a></li>
      <li><a href="./agentic-ai/ai-payload-inspection/">AI ペイロード検査</a></li>
    </ul></p>
  </div>
...
<div class="navigation navigation-3col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage deployment-title"><a href="./installation/supported-deployment-options/">デプロイ <span class="card-arrow">→</span></a></h3>
    <p class="card-description">マネージド、セルフホスト、コネクタベースで Wallarm をデプロイ。</p>
    <p><ul>
      <li><a href="./installation/security-edge/overview/">Security Edge（マネージド）</a></li>
      <li><a href="./admin-en/installation-kubernetes-en/">Kubernetes</a></li>
      <li><a href="./installation/cloud-platforms/aws/docker-container/">クラウドプラットフォーム</a></li>
      <li><a href="./installation/connectors/overview/">コネクタ</a></li>
      <li><a href="./installation/native-node/all-in-one/">セルフホストノード</a></li>
      <li><a href="./installation/oob/overview/">Out-of-Band</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage integration-title"><a href="./user-guides/settings/integrations/integrations-intro/">連携 <span class="card-arrow">→</span></a></h3>
    <p class="card-description">既存のセキュリティツール、SIEM、アラートシステムと Wallarm を接続。</p>
    <p><ul>
      <li><a href="./user-guides/settings/integrations/email/">メッセージとアラート</a></li>
      <li><a href="./user-guides/settings/integrations/pagerduty/">インシデント管理</a></li>
      <li><a href="./user-guides/settings/integrations/splunk/">SIEM と分析</a></li>
      <li><a href="./user-guides/settings/integrations/fluentd/">ログコレクタ</a></li>
      <li><a href="./user-guides/settings/integrations/amazon-s3/">クラウドストレージ</a></li>
  ...
  <div class="navigation-card">
    ...
    <p><ul>
      ...
      <li><a href="./user-guides/triggers/triggers/">トリガーとアラート</a></li>
      <li><a href="./user-guides/search-and-filters/use-search/">検索とレポート</a></li>
      <li><a href="./user-guides/settings/users/">ユーザーとアクセス</a></li>
      <li><a href="./troubleshooting/overview/">トラブルシューティング</a></li>
    </ul></p>
  </div>
...
<div class="demo-cta-section">
  <div class="demo-cta-content">
    <div class="demo-cta-left">
      <div class="demo-cta-label">WALLARM は初めてですか？</div>
      <h2 class="demo-cta-heading">5分で全体の仕組みをご覧ください</h2>
      <a href="./demo-videos/overview/" class="demo-cta-button">概要動画を見る</a>
    </div>
