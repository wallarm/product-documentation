...
تكتشف Wallarm وتقلل من هجمات سوء استخدام واجهة برمجة التطبيقات فقط إذا كان لديها وحدة [الوقاية من سوء استخدام واجهة برمجة التطبيقات](api-abuse-prevention/overview.md) ممكّنة ومكوّنة بشكل صحيح.
...
إذا أشارت المقاييس إلى علامات هجوم الروبوت، فإن الوحدة [ترفض أو تضع في القائمة الرمادية](api-abuse-prevention/overview.md#reaction-to-malicious-bots) مصدر حركة المرور الشاذة لمدة ساعة.
...
تكتشف Wallarm الهجمات الناجمة عن الحفز فقط إذا كان لديها وحدة [الوقاية من سوء استخدام واجهة برمجة التطبيقات](api-abuse-prevention/overview.md) ممكّنة ومكوّنة بشكل صحيح.
...
تكتشف Wallarm هجمات روبوتات الأمان فقط إذا كان لديها وحدة [الوقاية من سوء استخدام واجهة برمجة التطبيقات](api-abuse-prevention/overview.md) ممكّنة ومكوّنة بشكل صحيح.
