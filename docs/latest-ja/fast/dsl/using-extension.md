...
--8<-- "../include-ja/fast/console-include/dsl/fast-node-run-ok.md"
...
--8<-- "../include-ja/fast/console-include/dsl/fast-node-run-fail.md"
...
--8<-- "../include-ja/fast/console-include/dsl/fast-node-recording.md"
...
6.  In the FAST node console output you will see how:  
    ...
    * the non-modifying FAST extension executes for the URI parameter in the baseline request.
    --8<-- "../include-ja/fast/console-include/dsl/fast-node-working.md"
