...
# GraphQL API保護 <a href="../../about-wallarm/subscription-plans/#core-subscription-plans"><img src="../../../images/api-security-tag.svg" class="non-zoomable" style="border: none;"></a>
...
## Mitigation controlベースの保護 <a href="../../../about-wallarm/subscription-plans/#core-subscription-plans"><img src="../../../images/api-security-tag.svg" class="non-zoomable" style="border: none;"></a>
...
**GraphQL API protection** mitigation controlで説明したものと同じ設定を使用します。相違点は、Wallarm Console → **Security Controls** → **Rules WAF**で操作することだけです。