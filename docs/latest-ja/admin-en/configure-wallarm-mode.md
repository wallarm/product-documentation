...
=== "Rules"
    ...
    全体のフィルタリングモード設定は、**Rules WAF**セクションの**Set filtration mode**[default](../user-guides/rules/rules.md#default-rules)ルールとして表されます。このセクションでエンドポイントを対象とするフィルタリングルールの方が高い優先度を持つ点にご注意ください。
