...
![Mulesoft com política Wallarm](../../images/waf-installation/gateways/mulesoft/traffic-flow.png)
...
* O [Wallarm API Discovery](../../about-wallarm/api-discovery.md) não pode explorar o inventário da API com base no seu tráfego, pois a solução depende da análise das respostas.
...
Para aplicar a política Wallarm a todas as APIs usando a opção de política automatizada do [Mulesoft](https://docs.mulesoft.com/gateway/1.4/policies-automated-applying), siga estes passos:
