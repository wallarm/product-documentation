...
# Documentação Wallarm

Tudo o que você precisa para descobrir suas APIs, MCPs e agentes de IA, protegê-los contra ameaças e testar vulnerabilidades.
...
<div class="navigation navigation-1col">
  <div class="navigation-card homepage-intro">
    <h3 class="icon-homepage quick-start-title"><a href="./about-wallarm/overview/">Introdução <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Comece com a plataforma Wallarm e aprenda o essencial.</p>
    <p><ul>
      <li><a href="./about-wallarm/overview/">Visão geral da plataforma</a></li>
      <li><a href="./quickstart/getting-started/">Início rápido</a></li>
...
<div class="navigation navigation-4col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage api-discovery-title"><a href="./api-discovery/overview/">Descoberta de API <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Catalogue todas as suas APIs/MCPs/agentes, riscos e fluxos de dados sensíveis.</p>
    <p><ul>
      <li><a href="./api-discovery/exploring/">Explorando suas APIs</a></li>
      <li><a href="./api-discovery/risk-score/">Pontuação de risco</a></li>
      <li><a href="./api-discovery/rogue-api/">APIs Rogue (Shadow/Zombie)</a></li>
      <li><a href="./api-discovery/setup/">Configuração e instalação</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-threat-prevent"><a href="./about-wallarm/api-protection-overview/">Proteção de API <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Bloqueie ataques, bots e abuso em tempo real com detecção inteligente de ameaças.</p>
    <p><ul>
      <li><a href="./api-sessions/overview/">Sessões de API</a></li>
      <li><a href="./api-specification-enforcement/overview/">Conformidade com especificação de API</a></li>
      <li><a href="./api-abuse-prevention/overview/">Gerenciamento de bots</a></li>
      <li><a href="./about-wallarm/credential-stuffing/">Credential Stuffing</a></li>
      <li><a href="./about-wallarm/waap-overview/">Proteção contra ameaças (WAAP)</a></li>
      <li><a href="./user-guides/rules/rules/">Regras e políticas</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-security-testing"><a href="./vulnerability-detection/security-testing-overview/">Teste de segurança de API <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Encontre vulnerabilidades antes dos atacantes com testes de segurança automatizados.</p>
    <p><ul>
      <li><a href="./vulnerability-detection/threat-replay-testing/overview/">Teste de replay de ameaças</a></li>
      <li><a href="./vulnerability-detection/schema-based-testing/overview/">Teste baseado em esquema</a></li>
      <li><a href="./api-attack-surface/overview/">Superfície de ataque (AASM)</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage agent-ai-title"><a href="./agentic-ai/agentic-ai-discovery/">Segurança de IA <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Descubra e proteja agentes de IA e MCPs.</p>
    <p><ul>
      <li><a href="./agentic-ai/agentic-ai-discovery/">Descoberta de agente de IA</a></li>
      <li><a href="./agentic-ai/agentic-ai-protection/">Proteção de agente de IA</a></li>
      <li><a href="./agentic-ai/ai-payload-inspection/">Inspeção de payload de IA</a></li>
    </ul></p>
  </div>
...
<div class="navigation navigation-3col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage deployment-title"><a href="./installation/supported-deployment-options/">Implantação <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Implante o Wallarm com opções gerenciadas, self-hosted ou baseadas em conector.</p>
    <p><ul>
      <li><a href="./installation/security-edge/deployment/">Security Edge (Gerenciado)</a></li>
      <li><a href="./admin-en/installation-kubernetes-en/">Kubernetes</a></li>
      <li><a href="./installation/cloud-platforms/aws/docker-container/">Plataformas em nuvem</a></li>
      <li><a href="./installation/connectors/overview/">Conectores</a></li>
      <li><a href="./installation/native-node/all-in-one/">Node self-hosted</a></li>
      <li><a href="./installation/oob/overview/">Out-of-Band</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage integration-title"><a href="./user-guides/settings/integrations/integrations-intro/">Integrações <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Conecte o Wallarm às suas ferramentas de segurança, SIEMs e sistemas de alerta.</p>
    <p><ul>
      <li><a href="./user-guides/settings/integrations/email/">Mensagens e alertas</a></li>
      <li><a href="./user-guides/settings/integrations/pagerduty/">Gerenciamento de incidentes</a></li>
      <li><a href="./user-guides/settings/integrations/splunk/">SIEM e análise</a></li>
      <li><a href="./user-guides/settings/integrations/fluentd/">Coletores de log</a></li>
      <li><a href="./user-guides/settings/integrations/amazon-s3/">Armazenamento em nuvem</a></li>
  ...
  <div class="navigation-card">
    ...
    <p><ul>
      ...
      <li><a href="./user-guides/triggers/triggers/">Gatilhos e alertas</a></li>
      <li><a href="./user-guides/search-and-filters/use-search/">Pesquisa e relatórios</a></li>
      <li><a href="./user-guides/settings/users/">Usuários e acesso</a></li>
      <li><a href="./troubleshooting/overview/">Solução de problemas</a></li>
    </ul></p>
  </div>
...
<div class="demo-cta-section">
  <div class="demo-cta-content">
    <div class="demo-cta-left">
      <div class="demo-cta-label">NOVO NO WALLARM?</div>
      <h2 class="demo-cta-heading">Veja como tudo funciona em 5 minutos</h2>
      <a href="./demo-videos/overview/" class="demo-cta-button">Assistir à visão geral</a>
    </div>
