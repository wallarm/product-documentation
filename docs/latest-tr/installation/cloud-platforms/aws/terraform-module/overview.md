...
`upstream` | Dağıtılacak [Wallarm düğümü versiyonu](../../../../updating-migrating/versioning-policy.md#version-list). Minimum desteklenen versiyon `4.0`.<br><br>Varsayılan olarak `4.6`. | string | Hayır |
