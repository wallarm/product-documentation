...
* [Wallarm API Keşif](../../about-wallarm/api-discovery.md), çözümün yanıt analizine dayandığı için trafik üzerinde API envanterini keşfetme yeteneğine sahip olamaz.
