...
| [API4:2019 Lack of Resources & Rate Limiting](https://github.com/OWASP/API-Security/blob/master/editions/2019/en/0xa4-lack-of-resources-and-rate-limiting.md) | <ul><li>[Kaba kuvvet tetikleyici](../../admin-en/configuration-guides/protecting-against-bruteforce.md) sıklıkla DoS'a yol açan kaba kuvvet saldırılarını hafifletir, bu da API'nin yanıt verememesine veya hatta kullanılamaz hale gelmesine neden olur</li><li>[API İstismar Önleme](../../about-wallarm/api-abuse-prevention.md) sıklıkla DoS'a yol açan kötü amaçlı bot eylemlerini hafifletir, bu da API'nin yanıt verememesine veya hatta kullanılamaz hale gelmesine neden olur</li></ul> |
...
| [API6:2023 Unrestricted Access to Sensitive Business Flows](https://github.com/OWASP/API-Security/blob/master/editions/2023/en/0xa6-unrestricted-access-to-sensitive-business-flows.md) | <ul><li>[API İstismar Önleme](../../about-wallarm/api-abuse-prevention.md) kötü niyetli bot eylemlerini hafifletir</li></ul> |
