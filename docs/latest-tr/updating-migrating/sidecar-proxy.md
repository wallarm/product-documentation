...
[4.10.7 sürümü](/4.10/updating-migrating/node-artifact-versions/#helm-chart-for-sidecar), çözümün yeniden kurulmasını gerektiren uyumsuz değişiklikler getirmiştir. Varsayılan admission webhook sertifikası üretim yöntemi, [`certgen`](https://github.com/kubernetes/ingress-nginx/tree/main/images/kube-webhook-certgen) süreciyle değiştirilmiştir. Yükseltme sırasında sertifikalar yeni `certgen` süreci kullanılarak otomatik olarak üretilecektir.
