...
!!! warning "Community Ingress NGINX Controller'ın yükseltilmiş versiyonu"
    ...
    Community Ingress NGINX Controller 1.8.1 işleminin çokça değiştiğinden dolayı, yapılandırması bu değişikliklere uygulanmalıdır Wallarm Ingress denetleyicisi yükseltme süresince.
