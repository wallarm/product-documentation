...
* For installations via the [all-in-one installer](../installation/nginx/all-in-one.md), log files are situated within `/opt/wallarm/var/log/wallarm` and suffixed with `out`.
