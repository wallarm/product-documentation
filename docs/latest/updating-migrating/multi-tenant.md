...
1. Specify the tenant UUIDs received above in the [`wallarm_partner_client_uuid`](../admin-en/configure-parameters-en.md#wallarm_partner_client_uuid).
...
* Relations between the tenants and applications are defined via the `wallarm_partner_client_uuid` and `wallarm_application` directives in the corrsponding blocks of the NGINX configuration file.
