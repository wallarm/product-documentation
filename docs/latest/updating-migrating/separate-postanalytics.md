...
When upgrading from postanalytics module 4.x to 4.6 with all-in-one installer, you cannot upgrade an old package installation - instead you need to use a clean machine. Thus, as step 1, prepare a machine with the appropriate OS within you environment.
