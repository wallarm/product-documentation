...
1. Upgrade filtering node:
    ...
    === "API token"
        ...
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-5.0.2.x86_64-glibc.sh filtering

        # If using the ARM64 version:
        sudo env WALLARM_LABELS='group=<GROUP>' sh wallarm-5.0.2.aarch64-glibc.sh filtering
        ```        
    ...
    === "Node token"
        ```bash
        # If using the x86_64 version:
        sudo sh wallarm-5.0.2.x86_64-glibc.sh filtering

        # If using the ARM64 version:
        sudo sh wallarm-5.0.2.aarch64-glibc.sh filtering
        ```
