...
* [Rate abuse prevention](../api-protection/rate-abuse-protection.md) mitigation control (requires [Advanced API Security](../../about-wallarm/subscription-plans.md#waap-and-advanced-api-security) subscription).
