...
1. In the **API Specifications** section in [US Cloud](https://us1.my.wallarm.com/api-specifications/) or [EU Cloud](https://my.wallarm.com/api-specifications/), click **Upload specification**.
    ...
    !!! tip ""
        OAS 3.1 requires [NGINX Node](../installation/nginx-native-node-internals.md#nginx-node) 6.6.1 or higher or [Native Node](../installation/nginx-native-node-internals.md#native-node) 0.19.0 or higher.
