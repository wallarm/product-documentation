...
You can set additional email addresses that will be used to deliver scheduled PDF reports and instant notifications. Sending messages to your primary email is configured by default.
