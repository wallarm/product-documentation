...
[Jira](https://www.atlassian.com/software/jira) is a widely used project management and issue tracking software developed by Atlassian. You can set up Wallarm to create issues in Jira when [vulnerabilities](../../../about-wallarm/detecting-vulnerabilities.md#what-is-security-issue) are detected, all or only for the selected risk level(s) - high, medium or low.
