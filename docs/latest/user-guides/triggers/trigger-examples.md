...
Changes may occur in your API. They will be discovered by the [**API Discovery**](../../api-discovery/api-discovery-overview.md) module. Possible [changes](../../api-discovery/api-discovery-track-changes.md) are:
