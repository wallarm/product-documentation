...
* `graphql_attacks`: to search for all violations of the [organization's GraphQL policy](../../api-protection/graphql-rule.md). Also, specific violations can be searched by:
