...
* `payload_trigger`: to search for attacks detected by the [Number of malicious payloads](../../user-guides/triggers/triggers.md#step-1-choosing-a-condition) trigger and blocked requests from IPs [denylisted](../../user-guides/events/analyze-attack.md#analyze-requests-from-denylisted-ips) because of the attacks of this type.
