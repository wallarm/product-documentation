...
* `brute`: to search for [brute-force][al-brute-force] attacks, [including](../../user-guides/events/analyze-attack.md#analyze-requests-from-denylisted-ips) ones from denylisted IPs.
...
* `dirbust`: to search for [forced browsing][al-forced-browsing] attacks, [including](../../user-guides/events/analyze-attack.md#analyze-requests-from-denylisted-ips) ones from denylisted IPs.
...
* `bola`: to search for attacks exploiting the [BOLA (IDOR) vulnerability](../../attacks-vulns-list.md#broken-object-level-authorization-bola), [including](../../user-guides/events/analyze-attack.md#analyze-requests-from-denylisted-ips) ones from denylisted IPs.
...
* `payload_trigger`: to search for attacks detected by the [Number of malicious payloads](../../user-guides/triggers/triggers.md#step-1-choosing-a-condition) trigger, [including](../../user-guides/events/analyze-attack.md#analyze-requests-from-denylisted-ips) ones from denylisted IPs.
