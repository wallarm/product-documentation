...
Besides stopping bot protection based on the **source** IPs with [exception list](#working-with-exception-list), you can disable it for specific **target** URLs using the [**Set API Abuse Prevention mode**](../user-guides/rules/api-abuse-url.md) rule.
