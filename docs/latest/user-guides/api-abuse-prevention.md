...
1. If necessary, in **Protect from** section, limit the [types of bots](../about-wallarm/api-abuse-prevention.md#protecting-from-specific-bot-types) to protect from.
