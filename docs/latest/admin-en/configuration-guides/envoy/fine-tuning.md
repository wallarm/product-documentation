...
disable_acl | Allows disabling analysis of requests origins. If disabled (`on`), the WAF node does not download [IP lists](../../../user-guides/ip-lists/overview.md) from the Wallarm Cloud and skips request source IPs analysis. | `off`