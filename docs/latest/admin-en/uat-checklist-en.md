...
2. Add IP addresses to the [allowlist](../user-guides/ip-lists/allowlist.md), [denylist](../user-guides/ip-lists/overview.md), and [graylist](../user-guides/ip-lists/overview.md).
