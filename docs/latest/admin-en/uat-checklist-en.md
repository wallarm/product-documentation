...
1. Go to **Security Controls** → **WAF Rules**.
1. Use **Create rule** → **Attack fine-tuning (false positives)** → **Ignore certain attacks**, select to ignore **Path traversal** in the `uri` part of the request, then create the rule.
