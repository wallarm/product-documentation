...
!!! warning "Attention"
    Perform the steps described in this chapter only if the FAST node is being deployed either via [API][doc-node-deployment-api] or via [CI Mode (recording mode)][doc-fast-recording-mode].
