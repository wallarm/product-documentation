...
* [Discovers](api-surface.md) external hosts and their APIs by scanning domains, IP addresses, and network ranges (including hosting e.g. CDN, IaaS, or PaaS providers).
