...
| [BOLA protection](../admin-en/configuration-guides/protecting-against-bola-trigger.md) | Manual triggers | Mitigation control |
...
| [MCP mitigation controls](../agentic-ai/mcp-mitigation-controls.md) | No | Yes |
...
| [MCP Sessions](../api-sessions/mcp-sessions.md) | No | Yes |
| [API Discovery](../api-discovery/overview.md) | No | Yes |
| [MCP server discovery](../api-discovery/exploring.md#mcp-servers) | No | Yes |
...
| Period of event storage | 6 months | 6 months |
