...
| [Finding shadow and orphan APIs](../about-wallarm/api-discovery.md#shadow-and-orphan-apis) with API Discovery | No | Yes |
| [API Sessions](../about-wallarm/api-sessions.md) | No | Yes |
