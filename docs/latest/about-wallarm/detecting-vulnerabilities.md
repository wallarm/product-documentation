...
Passive detection and TRT require the [Wallarm node](../about-wallarm/api-security-overview.md#how-wallarm-api-security-works). SBT and AASM do not. Some [vulnerabilities](../attacks-vulns-list.md#vulnerability-types) are found only by some (not by all) of the listed methods.
