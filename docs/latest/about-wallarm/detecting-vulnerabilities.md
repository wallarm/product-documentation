...
Weak JWTs detection is enabled by default - if a significant amount of incoming requests processed by the Wallarm node contains weak JWTs, the corresponding vulnerability is recorded.
