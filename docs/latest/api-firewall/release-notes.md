...
* Introduced the capability to configure API Firewall to allow all requests using the `OPTIONS` method. This can be achieved using the `APIFW_PASS_OPTIONS` variable.
