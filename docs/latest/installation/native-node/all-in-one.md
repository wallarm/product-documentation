...
=== "connector-server"
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
=== "tcp-capture-v2"
    For the x86_64 installer version:
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
=== "envoy-external-filter"
    For the x86_64 installer version:
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com
        ```
...
* As soon as you have the all-in one script downloaded, you can get **help** on it with:
    ...
    === "x86_64 version"
        ```
        sudo ./aio-native-0.25.8.x86_64.sh -- --help
        ```
    === "ARM64 version"
        ```
        sudo ./aio-native-0.25.8.aarch64.sh -- --help
        ```
* You can also run the installer in an **interactive** mode and choose the required mode in the 1st step:

    === "x86_64 version"
        ```
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh
        ```
    === "ARM64 version"
        ```
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh
        ```
