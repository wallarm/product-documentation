...
1. Add the [Wallarm chart repository](https://charts.wallarm.com/):
    ...
    ```
4. Create the `values.yaml` file with the [Wallarm configuration](../../../admin-en/configure-kubernetes-en.md).
    ...
    Starting from Helm chart version 4.4.1, you can also store the Wallarm node token in Kubernetes secrets and pull it to the Helm chart. [Read more](../../../admin-en/configure-kubernetes-en.md#controllerwallarmexistingsecret)
    
    --8<-- "../include/waf/installation/info-about-using-one-token-for-several-nodes.md"
1. Install the Wallarm packages:

    ``` bash
    helm install --version 4.6.4 <RELEASE_NAME> wallarm/wallarm-ingress -n <KUBERNETES_NAMESPACE> -f <PATH_TO_VALUES>
    ```
...
To find parameters used for advanced configuration and appropriate instructions, please follow the [link](../../../admin-en/configure-kubernetes-en.md).
