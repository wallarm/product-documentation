...
# Wallarm eBPF-Based Soultion (Beta Version)
...
1. Deploy the Wallarm Helm chart:
    ...
    ``` bash
    helm install --version 0.10.2 <RELEASE_NAME> wallarm/wallarm-oob --wait -n wallarm-ebpf --create-namespace -f <PATH_TO_VALUES>
    ```
