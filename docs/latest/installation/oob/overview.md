...
* The [Wallarm API Discovery](../../api-discovery/api-discovery-overview.md) does not explore API inventory based on your traffic as server responses required for the module operation are not mirrored.
