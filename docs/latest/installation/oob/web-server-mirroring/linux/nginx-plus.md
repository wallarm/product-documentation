...
Among all supported [Wallarm deployment options](../../../supported-deployment-options.md), DEB/RPM packages for NGINX Plus is recommended for out‑of‑band Wallarm deployment in these **use cases**:
