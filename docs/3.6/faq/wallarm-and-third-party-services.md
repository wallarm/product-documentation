...
The Wallarm platform interacts with Tarantool feedback server (`https://feedback.tarantool.io`) to upload standard Tarantool instance data to, if you are using the NGINX Wallarm Node.
