...
=== "NGINX from Debian/CentOS repository"
    For NGINX [installed from Debian/CentOS repository](../../waf-installation/nginx/dynamic-module-from-distr/), please skip this step. The installed NGINX version will be upgraded [later](#step-6-upgrade-wallarm-api-security-packages) along with Wallarm modules.
