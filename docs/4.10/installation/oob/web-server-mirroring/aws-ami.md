...
1. Set the following configuration in the `/etc/nginx/sites-enabled/default` file on the the [machine running the Wallarm filtering node](#3-launch-a-wallarm-node-instance):
