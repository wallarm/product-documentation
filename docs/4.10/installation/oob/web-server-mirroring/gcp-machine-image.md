...
1. Set the following configuration in the `/etc/nginx/sites-enabled/default` file on the [machine running the Wallarm filtering node](#1-launch-a-filtering-node-instance):
