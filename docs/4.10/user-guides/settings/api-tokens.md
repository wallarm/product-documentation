...
* API Test Patrol agent - [required](../../vulnerability-detection/schema-based-testing/) for work of [API Test Patrol](../../vulnerability-detection/schema-based-testing/setup.md#prerequisites-token).
