...
<div class="homepage-top">
    <div class="navigation-card homepage-intro">
        ...
        <li><a href="./about-wallarm/protecting-against-attacks/">Getting Started</a></li>
...
<!-- Row 1: API Discovery, API Protection, API Security Testing -->
...
<div class="navigation-card">
    ...
    <li><a href="./agentic-ai/agentic-ai-discovery/">Agentic AI Discovery</a></li>
    </ul></p>
</div>
...
<div class="navigation-card">
    ...
    <li><a href="./fast/qsg/">FAST Platform</a></li>
    </ul></p>
</div>
...
<div class="navigation-card">
    ...
    <li><a href="./installation/oob/overview/">Out-of-Band (Traffic Mirror)</a></li>
    <li><a href="./installation/on-premise/overview/">On-Premise</a></li>
    <li><a href="./installation/multi-tenant/overview/">Multi-Tenant</a></li>
...
<div class="navigation-card">
    ...
    <p><ul>
    <li><a href="./user-guides/settings/integrations/integrations-intro/">Integrations Overview</a></li>
    ...
    <li><a href="./integrations-devsecops/verify-docker-image-signature/">DevSecOps</a></li>
    </ul></p>
</div>
...
<div class="navigation-card">
    ...
    <p><ul>
    <li><a href="./user-guides/user-intro/">Console Overview</a></li>
    <li><a href="./about-wallarm/subscription-plans/">Plans & Pricing</a></li>
    <li><a href="./user-guides/settings/users/">Users & Access</a></li>
    <li><a href="./admin-en/configuration-guides/allocate-resources-for-node/">Nodes & Infrastructure</a></li>
    ...
    <li><a href="./user-guides/settings/account/">Account Settings</a></li>
