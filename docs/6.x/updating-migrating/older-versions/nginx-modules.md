...
--8<-- "../include/waf/installation/all-in-one-nginx-6.x.md"
...
--8<-- "../include/waf/installation/all-in-one-installer-download-6.x.md"

## Step 5: Run all-in-one Wallarm installer

### Filtering node and postanalytics on the same server

--8<-- "../include/waf/installation/all-in-one-installer-run-6.x.md"
