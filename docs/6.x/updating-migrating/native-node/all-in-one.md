...
=== "x86_64 version"
    ```bash
    curl -O https://meganode.wallarm.com/native/aio-native-0.25.8.x86_64.sh
    chmod +x aio-native-0.25.8.x86_64.sh
    ```
=== "ARM64 version"
    ```bash
    curl -O https://meganode.wallarm.com/native/aio-native-0.25.8.aarch64.sh
    chmod +x aio-native-0.25.8.aarch64.sh
    ```
...
=== "connector-server"
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=connector-server --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
...
=== "tcp-capture-v2"
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=tcp-capture-v2 --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
...
=== "envoy-external-filter"
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.x86_64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
    ...
    * US Cloud:
        ...
        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host us1.api.wallarm.com --preserve false
        ```

    * EU Cloud:

        ```bash
        sudo env WALLARM_LABELS='group=<GROUP>' ./aio-native-0.25.8.aarch64.sh -- --batch --token <API_TOKEN> --mode=envoy-external-filter --go-node-config=<PATH_TO_CONFIG> --host api.wallarm.com --preserve false
        ```
