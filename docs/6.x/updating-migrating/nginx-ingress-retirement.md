...
To support customers beyond the lifecycle of the Community Ingress NGINX, Wallarm will introduce new deployment artifacts that offer long-term, fully supported alternatives.
...
Wallarm also offers an [Istio/Envoy-based connector](../installation/connectors/istio.md).
