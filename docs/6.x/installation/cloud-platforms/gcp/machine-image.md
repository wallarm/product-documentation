...
--8<-- "../include/waf/installation/cloud-platforms/reqs-and-steps-to-deploy-gcp-image-6.x.md"
...
--8<-- "../include/waf/installation/cloud-platforms/fine-tuning-options-6.x.md"
