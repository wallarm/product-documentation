# Security Edge Inline NGINX Overrides <a href="../../../../about-wallarm/subscription-plans/#security-edge-paid-plan"><img src="../../../../images/security-edge-tag.svg" class="non-zoomable" style="border: none;"></a>
...
!!! info "Unsupported directives"
    If you require additional directives not supported by default, contact support@wallarm.com.
...
| --------- | ----------- | ------- |
| `proxy_buffer_size` | Buffer size for reading the first part of the response. [More details](https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_buffer_size) | `4k` |
