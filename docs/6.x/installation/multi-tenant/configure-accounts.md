...
* For requests to be sent from **your own API client**, it is required to pass the [API token with Global Administrator's permissions](../../user-guides/settings/api-tokens.md) in the request.
...
* Users of this tenant account have no access to Wallarm Console.
...
To activate a previously deactivated tenant account, in the tenant selector, click **Show deactivated tenants**, then select **Activate** for your tenant.
