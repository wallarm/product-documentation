...
The Shell script [**getwallarm.sh**](https://github.com/wallarm/quick-start/blob/stable/2.18/getwallarm.sh) used for Wallarm API Security Platform quick start performs the following steps:
