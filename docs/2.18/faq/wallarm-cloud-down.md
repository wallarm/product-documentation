...
* The [denylist records](../user-guides/denylist.md) are also uploaded to the node and stored within it. The uploaded addresses will continue to be handled but only until expiration date/time.
...
* [Triggers](../user-guides/triggers/triggers.md) will stop working and thus:
    * [Denylist](../user-guides/denylist.md) stop being updated.
