...
!!! info "If Wallarm node is already installed in your environment"
    ...
    * If the version `2.18.x` or lower is specified, please increase the version of the image to `3.2.0-1` in all deployments and follow [instructions for 3.2](/admin-en/installation-guides/kubernetes/wallarm-sidecar-container-helm/). Support for installed versions will be deprecated soon.
