...
!!! info "If Wallarm node is already installed in your environment"
    ...
    * If the version `3.0.x` is installed, then follow the instructions for [Wallarm node 3.0](/admin-en/installation-kong-en/) and for [separate postanalytics 3.0](/admin-en/installation-postanalytics-en/).
