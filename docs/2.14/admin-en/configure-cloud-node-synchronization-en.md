...
| `WALLARM_SYNCNODE_INTERVAL`   | Interval between WAF node and Wallarm Cloud synchronizations in seconds. The value cannot be less than the default value. Default value is `600`.                                                                                                                                                                                                                                                                                                                                                      |
...
The `node.yaml` file contains parameters that define the way the regular WAF node will synchronize with the Wallarm Cloud. The `node.yaml` file containing the regular WAF node name and UUID, and secret key to access Wallarm API is created after running the `addnode` script.
...
| `syncnode.owner` | Owner for the files needed for the cloud WAF node operation. Default value is `root`.                                                                                                                                                                                           |
| `syncnode.group` | Group for the files needed for the cloud WAF node operation. Default value is `wallarm`.                                                                                                                                                                                          |
| `syncnode.mode`  | Access rights to the files needed for the cloud WAF node operation. Default value is `0640`.                                                                                                                                                                                      |
