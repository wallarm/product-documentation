...
!!! info "If Wallarm WAF is already installed in your environment"
    ...
    * If the version `2.18` is specified, follow the [instructions for 2.18](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
    * If the version `2.16` is specified, follow the [instructions for 2.16](../../../../../2.16/admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/) or increase the version of the image to `2.18` in all deployments and follow the [instructions for 2.18](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
    * If the version `2.14` or lower is specified, please increase the version of the image to `2.18` in all deployments and follow the [instructions for 2.18](../../../../../admin-en/installation-guides/kubernetes/wallarm-sidecar-container-manifest/).
