...
# Wallarm Dokümantasyonu

API'lerinizi, MCP'lerinizi ve yapay zeka ajanlarınızı keşfetmek, tehditlerden korumak ve güvenlik açıklarını test etmek için ihtiyacınız olan her şey.
...
<div class="navigation navigation-1col">
  <div class="navigation-card homepage-intro">
    <h3 class="icon-homepage quick-start-title"><a href="./about-wallarm/overview/">Giriş <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Wallarm platformu ile çalışmaya başlayın ve temel bilgileri öğrenin.</p>
    <p><ul>
      <li><a href="./about-wallarm/overview/">Platforma Genel Bakış</a></li>
      <li><a href="./quickstart/getting-started/">Hızlı Başlangıç</a></li>
      <li><a href="./demo-videos/overview/">Video Kılavuzları</a></li>
    </ul></p>
  </div>
</div>
...
<div class="navigation navigation-4col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage api-discovery-title"><a href="./api-discovery/overview/">API Keşfi <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Tüm API'lerinizi/MCP'lerinizi/ajanlarınızı, risklerini ve hassas veri akışlarını kataloglayın.</p>
    <p><ul>
      <li><a href="./api-discovery/exploring/">API'lerinizi Keşfetme</a></li>
      <li><a href="./api-discovery/risk-score/">Risk Puanı</a></li>
      <li><a href="./api-discovery/rogue-api/">Rogue API'ler (Gölge/Zombi)</a></li>
      <li><a href="./api-discovery/sensitive-data/">Hassas Veri Tespiti</a></li>
      <li><a href="./api-discovery/setup/">Kurulum ve Yapılandırma</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-threat-prevent"><a href="./about-wallarm/api-protection-overview/">API Koruması <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Akıllı tehdit tespiti ile saldırıları, botları ve kötüye kullanımı gerçek zamanlı engelleyin.</p>
    <p><ul>
      <li><a href="./api-sessions/overview/">API Oturumları</a></li>
      <li><a href="./api-specification-enforcement/overview/">API Spec Uygulaması</a></li>
      <li><a href="./api-abuse-prevention/overview/">Bot Yönetimi</a></li>
      <li><a href="./about-wallarm/credential-stuffing/">Credential Stuffing</a></li>
      <li><a href="./about-wallarm/waap-overview/">Tehdit Koruması (WAAP)</a></li>
      <li><a href="./user-guides/rules/rules/">Kurallar ve Politikalar</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage api-security-testing"><a href="./vulnerability-detection/security-testing-overview/">API Güvenlik Testi <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Otomatik güvenlik testi ile saldırganlardan önce güvenlik açıklarını bulun.</p>
    <p><ul>
      ...
      <li><a href="./api-attack-surface/overview/">Saldırı Yüzeyi (AASM)</a></li>
    </ul></p>
  </div>

  <div class="navigation-card">
    <h3 class="icon-homepage agent-ai-title"><a href="./agentic-ai/agentic-ai-discovery/">Yapay Zeka Güvenliği <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Yapay zeka ajanlarını ve MCP'leri keşfedin ve koruyun.</p>
    <p><ul>
      <li><a href="./agentic-ai/agentic-ai-discovery/">Yapay Zeka Ajanı Keşfi</a></li>
      <li><a href="./agentic-ai/agentic-ai-protection/">Yapay Zeka Ajanı Koruması</a></li>
      <li><a href="./agentic-ai/ai-payload-inspection/">Yapay Zeka Yükü İncelemesi</a></li>
    </ul></p>
  </div>
...
<div class="navigation navigation-3col">
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage deployment-title"><a href="./installation/supported-deployment-options/">Dağıtım <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Wallarm'ı yönetilen, self-hosted veya bağlayıcı tabanlı seçeneklerle dağıtın.</p>
    <p><ul>
      <li><a href="./installation/security-edge/overview/">Security Edge (Yönetilen)</a></li>
      <li><a href="./admin-en/installation-kubernetes-en/">Kubernetes</a></li>
      <li><a href="./installation/cloud-platforms/aws/docker-container/">Bulut Platformları</a></li>
  ...
  <div class="navigation-card">
    <h3 class="icon-homepage integration-title"><a href="./user-guides/settings/integrations/integrations-intro/">Entegrasyonlar <span class="card-arrow">→</span></a></h3>
    <p class="card-description">Wallarm'ı mevcut güvenlik araçlarınız, SIEM'ler ve uyarı sistemlerinizle bağlayın.</p>
    <p><ul>
      <li><a href="./user-guides/settings/integrations/email/">Mesajlaşma ve Uyarılar</a></li>
      <li><a href="./user-guides/settings/integrations/pagerduty/">Olay Yönetimi</a></li>
      <li><a href="./user-guides/settings/integrations/splunk/">SIEM ve Analitik</a></li>
      <li><a href="./user-guides/settings/integrations/fluentd/">Log Toplayıcılar</a></li>
      <li><a href="./user-guides/settings/integrations/amazon-s3/">Bulut Depolama</a></li>
  ...
  <div class="navigation-card">
    ...
    <p><ul>
      ...
      <li><a href="./user-guides/triggers/triggers/">Tetikleyiciler ve Uyarılar</a></li>
      <li><a href="./user-guides/search-and-filters/use-search/">Arama ve Raporlar</a></li>
      <li><a href="./user-guides/settings/users/">Kullanıcılar ve Erişim</a></li>
      <li><a href="./troubleshooting/overview/">Sorun Giderme</a></li>
    </ul></p>
  </div>
...
<div class="demo-cta-section">
  <div class="demo-cta-content">
    <div class="demo-cta-left">
      <div class="demo-cta-label">WALLARM'DA YENİ MİSİNİZ?</div>
      <h2 class="demo-cta-heading">5 Dakikada Nasıl Çalıştığını Görün</h2>
      <a href="./demo-videos/overview/" class="demo-cta-button">Genel Bakışı İzleyin</a>
    </div>
