...
You can find the node UUID in the **Nodes** section, [node details](../../user-guides/nodes/nodes.md#viewing-node-details). Click UUID to copy it or click **View events from this node for the day** (switches to the **Attacks** section).
