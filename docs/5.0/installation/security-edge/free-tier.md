...
After signing up, you will be automatically redirected to the **Welcome Wizard** to test demo traffic. Once you complete it, you will proceed to the **Security Edge Quick Setup wizard.**
