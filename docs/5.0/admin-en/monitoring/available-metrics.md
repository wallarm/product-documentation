...
* **Troubleshooting recommendations:**
    ...
    2. Check the filter node operation as described in the [instructions](../../admin-en/uat-checklist-en.md#node-registers-attacks). The value should increase by `1` after sending one test attack.
