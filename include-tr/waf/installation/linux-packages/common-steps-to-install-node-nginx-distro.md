## 1. Debian/CentOS depolarını ekleyin
...
## 2. Wallarm paketleriyle NGINX'i kurun

Komut aşağıdaki paketleri yükler:
...
## 3. Wallarm modülünü bağlayın

Sistem kurulumu için yapılandırma dosyalarını kopyalayın:
